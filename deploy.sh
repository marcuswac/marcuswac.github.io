...
SOURCE=master
# Name of the branch publishing public dir to github pages
TARGET=gh-pages
...
msg "Pulling down the \`gh-pages\` branch into \`public\` to help avoid merge conflicts"
git subtree pull --prefix=public \
    git@github.com:$USERNAME/$USERNAME.github.io.git $TARGET -m "Merge origin master"
...
msg "Pushing the updated \`public\` folder to the $TARGET branch"
